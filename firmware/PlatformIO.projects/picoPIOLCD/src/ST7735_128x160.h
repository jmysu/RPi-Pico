...
#define ST7735_YSTART_L     0x02
#define ST7735_XEND_H       0x00
#define ST7735_XEND_L       0x81
#define ST7735_YEND_H       0x00
#define ST7735_YEND_L       0xA0
#define ST7735_16BIT        0x55
...
static const uint8_t st7735_initSeq[] = {  // Format: cmd length (including cmd byte), post delay in units of 5 ms, then cmd payload
        ...
        //2, 0 , ST7735_MADCTL,0xC8,                                  // Set MADCTL: row then column BGR order
        2, 0 , ST7735_MADCTL,0x40,                                  // Set MADCTL: row then column RGB order, X-mirror
